...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($composer_id) {
        $stmt = $conn->prepare("INSERT INTO timeline_events (title, description, event_date, composer_id) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("sssi", $title, $description, $event_date, $composer_id);
    } else {
        $stmt = $conn->prepare("INSERT INTO timeline_events (title, description, event_date) VALUES (?, ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Add Timeline Event - Classical Music Hub</title>
    ...
    <style>
        ...
        * {
        ...
        /* Sidebar styles - same as manage.php */
        .sidebar {
        ...
        <main class="main-content">
            <div class="form-container">
                <div class="page-header">
                    ...
                    <p>Create a new historical event in classical music</p>
                </div>
